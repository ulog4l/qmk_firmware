...
tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_F14] = ACTION_TAP_DANCE_DOUBLE(KC_F14, KC_ENT),
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
        MT(MOD_LALT | MOD_LSFT, KC_ESC), KC_TILDE, KC_SCLN, KC_F14,
                   LT(_FUNCTION,KC_W),    KC_F,                  KC_P,                  KC_B,    KC_J,    KC_L,               KC_U,    LGUI_T(KC_Y), OSM(MOD_RALT),
        KC_A,            LGUI_T(KC_R),    LT(_NUMBERS, KC_S),    LT(_SYMBOLS, KC_T),    KC_G,    KC_M,    LT(_NAV, KC_N),    KC_E,    KC_I,         KC_O,
        OSM(MOD_LSFT),   LCTL_T(KC_X),    KC_C,                  KC_D,                  KC_V, KC_TRNS,   KC_K,    KC_H,              KC_COMM, KC_Z,   
                                    LT(_NUMBERS,KC_SPC), MO(_NAV),LT(_NAV,KC_BSPC), OSM(MOD_RSFT), TD(TD_F14)
    ),
    [_GAMING] = LAYOUT(//gaming
        KC_1, KC_2, KC_3, KC_F13,
                    KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,        KC_Y,        KC_LALT,     KC_ESC,   DF(_BASE),
        KC_LCTL,    KC_A,     KC_S,     KC_D,     KC_F,     KC_G,        KC_TAB,      KC_TRNS,     KC_TRNS,     KC_ENT,
        KC_LSFT,    KC_Z,     KC_C,     KC_V,     KC_B,     KC_0,        KC_TRNS,     KC_TRNS,       KC_F1,     KC_F2,
                                    KC_BSPC,     KC_SPC,  KC_F14, MO(_BASE2),KC_F13//for push to talk?
    ),
    [_BASE2] = LAYOUT(         
        MT(MOD_LALT | MOD_LSFT, KC_ESC), KC_TILDE, KC_SCLN, KC_F14,
                   LT(_FUNCTION,KC_W),    KC_F,                  KC_P,                  KC_B,    KC_J,    KC_L,               KC_U,    LGUI_T(KC_Y), OSM(MOD_RALT),
        KC_A,            LGUI_T(KC_R),    LT(_NUMBERS, KC_S),    LT(_SYMBOLS, KC_T),    KC_G,    KC_M,    LT(_NAV, KC_N),    KC_E,    KC_I,         KC_O,
        OSM(MOD_LSFT),   LCTL_T(KC_X),    KC_C,                  KC_D,                  KC_V, LGUI(KC_ENT),   KC_K,    KC_H,              KC_COMM, KC_Z,        
                                    LT(_NUMBERS,KC_SPC), LT(_NAV,KC_BSPC),LT(_NAV,KC_BSPC), OSM(MOD_RSFT), TD(TD_F14)
    ),
    [_NUMBERS] = LAYOUT(//NUMBERS+SYMBOLS
        KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,
                     KC_MINS,     KC_TILDE,     KC_LBRC,     KC_RBRC,     KC_TRNS,         KC_7,     KC_8,     KC_9,KC_TRNS,
        KC_ASTR,     KC_PLUS,     KC_UNDS,     KC_SLSH,     KC_BSLS,     RALT(KC_5),         KC_4,     KC_5,     KC_6,     KC_TRNS,
        OSM(MOD_LSFT),    KC_COLON,    KC_GRV,     KC_LPRN,     KC_RPRN,   KC_TRNS,  KC_0,           KC_1,     KC_2,     KC_3,     
                                             KC_TRNS,     KC_TRNS, KC_TRNS,  KC_TRNS,  KC_ENT
    ),
    [_SYMBOLS] = LAYOUT(//shifted symbols
        KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,
                     KC_MINS,     KC_EQUAL,     KC_TRNS,     KC_TRNS,     KC_TRNS,         KC_AMPR,       KC_ASTR,    KC_SCLN,KC_TRNS,
        KC_ASTR,     KC_TILDE,     KC_UNDS,     KC_TRNS,     KC_TRNS,     KC_TRNS,         KC_DOLLAR,     KC_PERC,    KC_CIRC,     KC_TRNS,
        KC_PLUS,      KC_COLON,     KC_GRV,     KC_TRNS,     KC_TRNS,  KC_TRNS,   KC_QUESTION,           KC_EXCLAIM,    KC_AT,      KC_HASH,     
                                             KC_TRNS,     KC_TRNS, KC_TRNS, KC_TRNS,   KC_TRNS
    ),
    [_FUNCTION] = LAYOUT(//Fkeys + {},<>
        KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,
                     KC_TRNS,    KC_TRNS,     KC_LCBR,     KC_RCBR,     KC_F12,         KC_F7,     KC_F8,     KC_F9,QK_BOOT,
        KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_LABK,    KC_RABK,     KC_F11,         KC_F4,     KC_F5,     KC_F6,     KC_TRNS,
        KC_TRNS,    KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,  KC_TRNS,   KC_F10,           KC_F1,     KC_F2,     KC_F3,     
                                             KC_TRNS,     KC_TRNS,KC_TRNS,  KC_TRNS,   KC_TRNS
    ),
    [_NAV] = LAYOUT(//nav for thumb ff
        KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,
    MT(MOD_LALT | MOD_LSFT, KC_ESC),     KC_UP,     KC_LALT,     KC_TRNS,       KC_TRNS,       KC_7,     KC_8,     KC_9,DF(_GAMING),
                 KC_TAB,     KC_LEFT,    KC_DOWN,     KC_RIGHT,   KC_TRNS ,       KC_TRNS,     KC_4,     KC_5,     KC_6,     QK_LEAD,
                 KC_TRNS,    KC_TRNS,    KC_TRNS,     KC_DEL,  KC_INS,    KC_TRNS,     KC_0,           KC_1,     KC_2,     KC_3,     
                                             KC_TRNS,    KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS
    ),
