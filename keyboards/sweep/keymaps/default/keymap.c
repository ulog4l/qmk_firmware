...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_split_3x5_2(
    MT(MOD_LALT | MOD_LSFT, KC_ESC),               LT(_FUNCTION,KC_W),    KC_F,                  KC_P,                  KC_B,    KC_J,    KC_L,        KC_U,    LGUI_T(KC_Y), KC_RALT,
        LSFT_T(KC_A),            LGUI_T(KC_R),    LT(_NUMBERS, KC_S),    LT(_SYMBOLS, KC_T),    KC_G,    KC_M,    LT(_NAV, KC_N),    KC_E,    KC_I,         LSFT_T(KC_O),
        MO(_LEFT) ,   LCTL_T(KC_X),    KC_C,                  KC_D,                  KC_V,    KC_K,    KC_H,              KC_COMM, KC_Z,        OSM(MOD_RALT),
                                  MO(_NUMBERS),   LT(_NAV,KC_SPC),             KC_BSPC,   OSM(MOD_RSFT)
  ),
  [_GAMING]= LAYOUT_split_3x5_2(
        KC_LCTL, KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,        KC_Y,        KC_LALT,     KC_ESC, KC_TRNS,
        KC_LSFT,    KC_A,     KC_S,     KC_D,     KC_F,     KC_G,        KC_TAB,      KC_TRNS,     KC_F1,     KC_ENT,
        KC_LCTL,    KC_Z,     KC_C,     KC_V,     KC_B,     KC_0,        KC_ENT,      KC_TRNS,     KC_F2,     DF(_BASE),
        KC_BSPC, KC_SPC, MO(_BASE2), KC_F13
  ),
  [_BASE2] = LAYOUT_split_3x5_2(
    MT(MOD_LALT | MOD_LSFT, KC_ESC),               LT(_FUNCTION,KC_W),    KC_F,                  KC_P,                  KC_B,    KC_J,    KC_L,        KC_U,    LGUI_T(KC_Y), KC_RALT,
        LSFT_T(KC_A),            LGUI_T(KC_R),    LT(_NUMBERS, KC_S),    LT(_SYMBOLS, KC_T),    KC_G,    KC_M,    LT(_NAV, KC_N),    KC_E,    KC_I,         LSFT_T(KC_O),
        MO(_LEFT) ,   LCTL_T(KC_X),    KC_C,                  KC_D,                  KC_V,    KC_K,    KC_H,              KC_COMM, KC_Z,        OSM(MOD_RALT),
                                  MO(_NUMBERS),   LT(_NAV,KC_SPC),             KC_BSPC,   OSM(MOD_RSFT)
  ...
  [_NUMBERS] = LAYOUT_split_3x5_2(
     KC_TRNS, KC_MINS,     KC_TILDE,     KC_LBRC,     KC_RBRC,     KC_TRNS,         KC_7,     KC_8,     KC_9, KC_TRNS,
        KC_ASTR,     KC_EQUAL,     KC_UNDS,     KC_SLSH,     KC_BSLS,     RALT(KC_5),         KC_4,     KC_5,     KC_6,     KC_TRNS,
  ...
  [_SYMBOLS] = LAYOUT_split_3x5_2(
    KC_TRNS,  KC_MINS,     KC_EQUAL,     KC_TRNS,     KC_TRNS,     KC_TRNS,         KC_AMPR,       KC_ASTR,    KC_SCLN, KC_TRNS,
  ...
  [_FUNCTION] = LAYOUT_split_3x5_2(//Fkeys + {},<>
        KC_TRNS,    KC_TRNS,    KC_TRNS,     KC_LCBR,     KC_RCBR,     KC_F12,         KC_F7,     KC_F8,     KC_F9,KC_TRNS,
  ...
  [_NAV] = LAYOUT_split_3x5_2(
    KC_TRNS, MT(MOD_LALT | MOD_LSFT, KC_ESC),     KC_UP,     KC_LALT,     KC_TRNS,       KC_TRNS,       KC_TRNS,KC_TRNS,KC_TRNS, KC_TRNS,
                 KC_TAB,     KC_LEFT,    KC_DOWN,     KC_RIGHT,   KC_TRNS ,       KC_LEFT ,       KC_DOWN,    KC_UP,KC_RIGHT,     QK_LEAD,
                 KC_TRNS,    KC_TRNS,    KC_TRNS,     KC_DEL,  KC_INS,         KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,     DF(_GAMING),
                                             KC_TRNS,    KC_TRNS,  KC_TRNS,  KC_TRNS
  ),
   
  [_LEFT] = LAYOUT_split_3x5_2(//nav for thumb
    KC_TRNS, KC_9,KC_8,KC_7,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS, KC_TRNS,
    KC_TRNS,KC_6,KC_5,KC_4,KC_TRNS,KC_LEFT,KC_DOWN,KC_UP,KC_RIGHT,KC_DOLLAR,
    KC_TRNS,KC_3,KC_2,KC_1,KC_0,KC_TRNS,KC_TRNS,KC_ESC,KC_I,KC_TRNS,
                        KC_TRNS,    KC_TRNS,  KC_TRNS,  KC_TRNS
    ),
};
