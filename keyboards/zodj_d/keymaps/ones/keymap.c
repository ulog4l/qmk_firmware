...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_ones(
        ...
        LALT_T(KC_A),            LGUI_T(KC_R),    LT(_NUMBERS, KC_S),    LT(_SYMBOLS, KC_T),    KC_G,    KC_M,    LT(_NAV, KC_N),    KC_E,    KC_I,         KC_O,
        OSM(MOD_LSFT),   LCTL_T(KC_X),    KC_C,                  KC_D,                  KC_V,    KC_K,    KC_H,              KC_COMM, KC_Z,        OSM(MOD_RALT),
                            KC_TRNS,        LT(_NUMBERS,KC_SPC), LT(_NAV,KC_BSPC), OSM(MOD_RSFT), TD(TD_F13)
    ),
    [_GAMING] = LAYOUT_ones(//gaming
        ...
        KC_LSFT,    KC_Z,     KC_C,     KC_V,     KC_B,     KC_0,        KC_ENT,      KC_TRNS,     KC_F2,     DF(_BASE),
                          KC_TRNS,          LT(_NUMBERS, KC_BSPC),     KC_SPC,   MO(_BASE2), KC_F13//for push to talk?
    ),
    [_BASE2] = LAYOUT_ones(
        ...
        OSM(MOD_LSFT),   LCTL_T(KC_X),    KC_C,                  KC_D,                  KC_V,    KC_K,    KC_H,              KC_COMM, KC_Z,        OSM(MOD_RALT),
                           KC_TRNS,         LT(_NUMBERS,KC_SPC), LT(_NAV,KC_BSPC), OSM(MOD_RSFT), KC_F13
    ),
    [_NUMBERS] = LAYOUT_ones(//NUMBERS+SYMBOLS
        ...
        KC_EQUAL,    KC_COLON,    KC_GRV,     KC_LPRN,     KC_RPRN,     KC_0,           KC_1,     KC_2,     KC_3,     KC_TRNS,
                                    KC_TRNS,         KC_TRNS,     KC_TRNS,   KC_TRNS,  KC_ENT
    ),
    [_SYMBOLS] = LAYOUT_ones(//shifted symbols
    ...
    [_NAV] = LAYOUT_ones(//nav for thumb ff
